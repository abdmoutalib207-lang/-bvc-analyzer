...
# fonction de `update_data.py` seule n'aurait presque rien changé à
# l'écran.
#
# ⚠️ Une première livraison de ce correctif embarquait le collecteur
# ENTIER de la branche de recherche — garde-fou d'identité, couche de
# contamination, import par export — dont les dépendances n'étaient pas
# jointes : appliqué sur la base publiée, il levait `ModuleNotFoundError:
# identites`. Ce fichier ne reçoit ici QUE la fonction.
